...
(function (DeadwoodEngine) {
    function createGame(deps = {}) {
        ...
        const root = (_b = deps.root) !== null && _b !== void 0 ? _b : (typeof window !== "undefined" ? window : globalThis);
        const hasDom = (_c = deps.hasDom) !== null && _c !== void 0 ? _c : (typeof window !== "undefined" && typeof document !== "undefined");
        const random = (_d = deps.random) !== null && _d !== void 0 ? _d : Math.random;
        const seed = (_e = deps.seed) !== null && _e !== void 0 ? _e : null;
        const persistReport = (_f = deps.persistReport) !== null && _f !== void 0 ? _f : defaultPersistReport;
        ...
        async function defaultPersistReport(report) {
            var _a;
            ...
            if (!response.ok) {
                return {
                    ok: false,
                    error: (_a = result.error) !== null && _a !== void 0 ? _a : "REPORT SAVE FAILED",
                };
            }
            return result;
        }
        ...
        function livingCrewPeakVitals(crew = state.crew) {
        ...
        function createEmptyRunReport() {
            ...
            return {
                ...
                peaks: {
                    ...
                    maxCrewHunger: (_a = livingPeakVitals === null || livingPeakVitals === void 0 ? void 0 : livingPeakVitals.maxHunger) !== null && _a !== void 0 ? _a : 0,
                    minCrewHealth: (_b = livingPeakVitals === null || livingPeakVitals === void 0 ? void 0 : livingPeakVitals.minHealth) !== null && _b !== void 0 ? _b : 0,
        ...
        function recordMutinyAssessment(assessment) {
            ...
            currentRunReport.counters.mutiny.peakChance = Math.max(currentRunReport.counters.mutiny.peakChance, assessment.chance);
        }
        function recordMutinyBlocked(outcome) {
        ...
        function updateCrewMember(member) {
            ...
            const leaderCanBreakBySuicide = !member.isLeader ||
                livingCrew().length === 1;
        ...
        function removeCrewMember(member, fate, detail, aftermath) {
            ...
            const leaderCanBeExiledWithoutRankProtection = member.isLeader &&
                fate === "is exiled" &&
                !DeadwoodModel.leaderHasRankProtection(state.crew);
            const resolvedFate = member.isLeader && (fate === "deserts" ||
                (fate === "is exiled" && !leaderCanBeExiledWithoutRankProtection))
                ? "dies"
                : fate;
            const resolvedDetail = member.isLeader && fate === "deserts"
                ...
                : leaderCanBeExiledWithoutRankProtection
                    ...
                    : member.isLeader && fate === "is exiled"
                        ...
                        : detail;
            const lossType = resolvedFate === "dies" ? "death" :
        ...
        function resolveMutinyPressure() {
            ...
            else if (state.lastNightAction === "campfire" ||
                state.lastNightAction === "whiskey" ||
                state.lastNightAction === "rite" ||
        ...
        function affectCrew(stats) {
            var _a, _b, _c, _d, _e;
            const fearDelta = (_a = stats.fear) !== null && _a !== void 0 ? _a : 0;
            const fearRecoveryFactor = fearDelta < 0
                ? (state.fear >= 75 ? 0.62 :
                    state.fear >= 50 ? 0.74 :
                        0.84) - (stabilizingNightPenalty() * 0.03)
                : 1;
            const adjustedFearDelta = fearDelta < 0
                ? Math.ceil(fearDelta * Math.max(0.35, fearRecoveryFactor))
                : fearDelta;
            for (const member of livingCrew()) {
                member.morale += ((_b = stats.morale) !== null && _b !== void 0 ? _b : 0) + randInt(-1, 1);
        ...
        function distributeCrewFood(level) {
            ...
            for (const member of living) {
                ...
                const hungerBias = level === "poor" ? (member.hunger / 140) :
        ...
        function assignGuardDuty() {
            ...
            const sorted = pressuredDuty
                ? [...living].sort((left, right) => ((right.health + right.morale + right.loyalty) - (right.fear * 0.9)) -
        ...
        function resolveCrewConsequences() {
            const mutinyAssessment = DeadwoodModel.assessMutiny(state.crew, state.morale, state.fear, state.week, state.mutinyPressure);
            ...
            if (mutinyAssessment.eligible && outcome.type === "collapse") {
                ...
                state.pendingMessages.push("THE CAMP NEARLY SHATTERS BEFORE DAWN, BUT THE CREW TURNS ITS ANGER INTO A HARDER SILENCE. WHATEVER BREAK COMES NEXT MAY NOT FALL ON THE WEAKEST HAND.");
            ...
            if (outcome.type === "food-exile") {
                removeCrewMember(target, "is exiled", `${crewFirstName(target)} HAS BEEN LIVING TOO EASY WHILE THE OTHERS COUNT BONES, DUTIES, AND SMALL INJUSTICES. THE CREW WILL NOT TOLERATE IT ANY LONGER.`, { morale: -5, fear: 7, loyalty: -7 });
                return;
            }
        ...
        function sanctityExposureLevel() {
        ...
        function sanctityEncounterBonus() {
        ...
        function sanctityNightEventBonus() {
            const exposure = sanctityExposureLevel();
            if (exposure === "open") {
                return 20;
            }
        ...
        function sanctityStampedeThresholds() {
            const exposure = sanctityExposureLevel();
            if (exposure === "open") {
        ...
        function sanctityStampedeLossMultiplier() {
            const exposure = sanctityExposureLevel();
            if (exposure === "open") {
                return 1.3;
            }
        ...
        function statusLines() {
            ...
            return [
                ...
                `CASH ${state.cash}${deltaText(state.cash, previous === null || previous === void 0 ? void 0 : previous.cash)}`,
                "",
                `CREW: MORALE ${state.morale}${deltaText(state.morale, previous === null || previous === void 0 ? void 0 : previous.morale)}   FEAR ${state.fear}${deltaText(state.fear, previous === null || previous === void 0 ? void 0 : previous.fear)} (${fearLabel()})   MUTINY ${state.mutinyPressure}${deltaText(state.mutinyPressure, previous === null || previous === void 0 ? void 0 : previous.mutinyPressure)}`,
        ...
        async function trailEvent(blockedEncounter = null) {
            ...
            if (state.miles < 310) {
                ...
                if (blockedEncounter !== "hollow-drover" &&
        ...
        function autocomplete(input) {
            ...
            function resolveSingleMatch(matches) {
                if (matches.length === 1) {
                    return matches[0];
                }
    ...
    DeadwoodEngine.createGame = createGame;
})(DeadwoodEngine || (DeadwoodEngine = {}));
const deadwoodGlobal = globalThis;
